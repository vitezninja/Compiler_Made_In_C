...
static const char *astNode_typeAsStrings[] = {
    ...
    [AST_SWITCH_DEFAULT] = "AST_SWITCH_DEFAULT",
    [AST_LOOP_STATEMENT] = "AST_LOOP_STATEMENT",
    [AST_FOR_STATEMENT] = "AST_FOR_STATEMENT",
    [AST_FOR_INITIALIZER] = "AST_FOR_INITIALIZER",
    [AST_FOR_CONDITION] = "AST_FOR_CONDITION",
    [AST_FOR_INCREMENTATION] = "AST_FOR_INCREMENTATION",
    ...
    [AST_POSTFIX_PRIME_EXPRESSION] = "AST_POSTFIX_PRIME_EXPRESSION",
    [AST_ARRAY_INDEXING_EXPRESSION] = "AST_ARRAY_INDEXING_EXPRESSION",
    [AST_FUNCTION_CALL_EXPRESSION] = "AST_FUNCTION_CALL_EXPRESSION",
    [AST_PRIMARY_EXPRESSION] = "AST_PRIMARY_EXPRESSION",
};
